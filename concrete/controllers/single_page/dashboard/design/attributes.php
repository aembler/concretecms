...
namespace Concrete\Controller\SinglePage\Dashboard\Design;
...
class Attributes extends DashboardAttributesPageController
{
    ...
    public function edit($akID = null)
    {
        ...
        $this->renderEdit($key, Url::to('/dashboard/design/attributes', 'view'));
    }
    ...
    public function update($akID = null)
    {
        ...
        $this->executeUpdate($key, Url::to('/dashboard/design/attributes', 'view'));
    }
    ...
    public function select_type($type = null)
    {
        ...
        $this->renderAdd($type, Url::to('/dashboard/design/attributes', 'view'));
    }
    ...
    public function add($type = null)
    {
        ...
        $this->executeAdd($type, Url::to('/dashboard/design/attributes', 'view'));
    }
    ...
    public function delete($akID = null)
    {
        ...
        $this->executeDelete($key, Url::to('/dashboard/design/attributes', 'view'));
    }
