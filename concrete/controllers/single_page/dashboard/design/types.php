...
class Types extends DashboardPageController
{
    ...
    public function delete($ptID = false)
    {
        ...
        if (!$this->error->has()) {
            $pagetype->delete();
            $this->redirect('/dashboard/design/types', 'page_type_deleted', $pagetype->getSiteTypeID());
        }
        $this->view();
    }
    ...
    public function duplicate($ptID = false)
    {
        ...
        if (!$this->error->has()) {
            ...
            $this->redirect('/dashboard/design/types', 'page_type_duplicated', $pagetype->getSiteTypeID());
        }
        $this->view();
    }
    ...
    public function submit($ptID = false)
    {
        ...
        if (!$this->error->has()) {
            ...
            $this->redirect('/dashboard/design/types', 'page_type_updated', $pagetype->getSiteTypeID());
        }
        $this->edit($ptID);
    }
}
