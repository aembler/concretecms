...
namespace Concrete\Controller\SinglePage\Dashboard\Design\Containers;
...
class Add extends DashboardPageController
{
    public function view()
    {
        ...
        $this->render('/dashboard/design/containers/form');
    }
    ...
    public function add_container()
    {
        if ($this->token->validate('add_container')) {
            ...
            if ($errorList->has()) {
                ...
                return $this->buildRedirect('/dashboard/design/containers');
            }
        } else {
