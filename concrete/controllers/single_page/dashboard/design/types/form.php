<?php
namespace Concrete\Controller\SinglePage\Dashboard\Design\Types;
...
class Form extends DashboardPageController
{
    public function view($ptID = false, $message = false)
    {
        ...
        if (!$this->pagetype) {
            $this->redirect('/dashboard/design/types');
        }
    ...
    public function delete_set($ptComposerFormLayoutSetID = false)
    {
        ...
        if (!$this->error->has()) {
            $set->delete();
            $this->redirect('/dashboard/design/types/form', $set->getPageTypeID(), 'layout_set_deleted');
        }
    }
    ...
    public function update_set($ptComposerFormLayoutSetID = false)
    {
        ...
        if (!$this->error->has()) {
            ...
            $this->redirect('/dashboard/design/types/form', $set->getPageTypeID(), 'layout_set_updated');
        }
    }
    ...
    public function add_set($ptID = false)
    {
        ...
        if ($this->token->validate('add_set')) {
            ...
            $this->redirect('/dashboard/design/types/form', $this->pagetype->getPageTypeID(), 'layout_set_added');
        }
    }
